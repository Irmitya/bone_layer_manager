...
class BLTGGLE_OT_toggledefs(bpy.types.Operator):
    # Toggle Deform Bones Isolated View (Shift+ Click to invert)
    bl_idname = "bone_layer_man.deformerisolate"
    bl_label = "Toggle defrom view"
    bl_description = "Toggle Deform Bones isolated view \nShift + Click toggles Non-Deform Bones isolated view"
